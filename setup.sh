...
az storage blob upload --account-name mystorageaccountunique2 --container-name conradcontainer --name part-r-00000-f5c243b9-a015-4a3b-a4a8-eca00f80f04c.json --file part-r-00000-f5c243b9-a015-4a3b-a4a8-eca00f80f04c.json --overwrite
...
az cosmosdb mongodb collection create --account-name conradcosmosdb --database-name mydatabase --name classification-colors-ml-collection --resource-group myResourceGroup3 --shard 'key' --throughput 400